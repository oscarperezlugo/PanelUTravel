<%@ Page Title="Tarrago Reach System" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListaChoferes.aspx.cs" Inherits="ReachSystem.ListaChoferes" %>
...
<PagerStyle CssClass="pgr"></PagerStyle>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:tarragoReachConnectionString %>" SelectCommand="SELECT [IDUser], [Email], [Nombre], [Telefono], [FechaRegistro] FROM [Usuario] WHERE ([NumeroLicen] IS NOT NULL)">
    </asp:SqlDataSource>
...
<PagerStyle CssClass="pgr"></PagerStyle>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:tarragoReachConnectionString %>" SelectCommand="SELECT [IDUser], [Email], [Nombre], [Telefono], [FechaRegistro] FROM [Usuario] WHERE (([NumeroLicen] IS NOT NULL) AND ([Nombre] LIKE '%' + @Nombre + '%'))">
                        <SelectParameters>
